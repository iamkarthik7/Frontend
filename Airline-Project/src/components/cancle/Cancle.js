...
//       <Link to="/cancle" id="hover" class="nav-link active" href="#" tabindex="-1" aria-disabled="true">Cancle Ticket</Link><span style={{marginLeft:"7px", marginTop:"7px",marginRight:"7px"}}>|</span>
//       <Link to="/home" id="hover" onClick={this.home} class="nav-link " href="#" style={{marginLeft:"890px"}}>Logout</Link>
//     </div>
//   </div>
// </nav>
// <div id="table1">
...
//             <td><Link type="Submit" 
//                 onClick={this. delete=()=>{
//                   fetch('https://localhost:44341/api/Booking/'+item.ticketnumber,{
//                             method:'DELETE',
//                             headers:{'Accept':'application/json',
//                             'Content-Type':'application/json'
//                           }
...
//   </tbody> 
//   </table> 
//   <img id="imgcancle"  src="\Images\image1.jpg"></img>
//             </div>
...
// const emailValidator = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
// const passwordValidator = /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])[0-9a-zA-Z]{6,15}$/;
// const ticketValidator=/^[0-9]{3,100}$/;
...
//     if(!ticketValidator.test(this.state.ticketnumber))
//     {
//       ticketnumberError = 'please enter valid Ticketnumber';
//     }
  
//       if(emailError || passwordError || ticketnumberError){
//         this.setState({emailError, passwordError, ticketnumberError});
//         return false;
//       }
//       return true;
//     }
...
//       window.confirm("Cancle Your ticket")
//       fetch('https://localhost:44341/api/Booking/'+this.state.ticketnumber,{
//         method:'DELETE',
//         headers:{'Accept':'application/json',
//         'Content-Type':'application/json'
//       }
...
//       axios.post(`https://localhost:44341/api/tcancle`,this.state)
//       .then(response=>{
//         window.alert("Your Ticket Cancled.... Thank You.")
//         window.location.href="/Cancle";
//       })
...
//     render() {
//       const {ticketnumber, email, password}=this.state
...
//               <Link id="hover"class="nav-link active" href="#">Cancle Ticket</Link>
//               <Link to="/home" id="hover" onClick={this.home} class="nav-link-danger active " href="#" style={{marginLeft:"750px"}}>Logout</Link>
//              </div>
//             </div>
//               </nav>
//                 <form id="loginform" class="rounded" onSubmit={this.handleSubmit}>
...
//                         <input type="text" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="-- enter your ticket number  --" style={{background:"transparent"}}
//                         name="ticketnumber" value={this.state.ticketnumber} onChange={this.handleChange} value={ticketnumber}/>
//                          <div style={{color:"red", fontSize:12}}>{this.state.ticketnumberError}</div>
//                     </div>
//                     <div class="form-group ">
//                         <label for="exampleInputEmail1">Email</label>
//                         <input type="email" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="-- enter your  Email  --" style={{background:"transparent"}}
//                         name="email" value={this.state.email} onChange={this.handleChange} value={email}/>
//                          <div style={{color:"red", fontSize:12}}>{this.state.emailError}</div>
//                     </div>
//                 <div class="form-group">
